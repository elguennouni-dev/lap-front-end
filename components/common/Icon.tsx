...
export const Icon: React.FC<IconProps> = ({ name, ...props }) => {
  switch (name) {
    case 'logo':
      return (
<<<<<<< HEAD
        <img {...props} viewBox="0 0 24 24" src="assets\lap_logo.png" alt="logo" />
=======
        ...
        // </svg>
        <img {...props} viewBox="0 0 24 24" src="https://github.com/elguennouni-dev/lap-front-end/blob/main/assets/lap_logo.png" alt="logo" />
>>>>>>> b29561f6b28e13f46b19ebd28a7c1b675c0aa81f
      );
    case 'logout':
        return (
